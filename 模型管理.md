...
```
#GIM转换工具的路径地址
uino.gim-convertor-url=http://hd.huakunsoft.com.cn:13385/gim-boot/api/gim
```
...
```
POST  http://hd.huakunsoft.com.cn:13385/gim-boot/api/gim/loadGim?biz=upload
```
...
| 字段名 |                                                                 | 类型 | 是否必须 |
| ------ | --------------------------------------------------------------- | ---- | -------- |
| file   | file://D:\project\huakun\gim\doc\data\同里 220KV 变电站工程.gim | File | 是       |
...
```
GET  http://hd.huakunsoft.com.cn:13385/gim-boot/api/gim/getTaskById?taskId=1777958733951811586
```
...
```
GET  http://hd.huakunsoft.com.cn:13385/gim-boot/api/gim/exportGLTF?projectId=b29f19b3-f139-491c-9f60-2a9d0b08d3af&option=1
```
...
```
GET  http://hd.huakunsoft.com.cn:13385/gim-boot/api/gim/exportFBX?projectId=b29f19b3-f139-491c-9f60-2a9d0b08d3af&option=1
```
...
```
GET  http://hd.huakunsoft.com.cn:13385/gim-boot/api/gim/getJSON?projectId=b29f19b3-f139-491c-9f60-2a9d0b08d3af
```
...
```
GET  http://hd.huakunsoft.com.cn:13385/gim-boot/api/gim/getGLTF?file=result/1779866802210353153.zip
```
...
```
GET  http://hd.huakunsoft.com.cn:13385/gim-boot/api/gim/getExportTaskProgress?projectId=b29f19b3-f139-491c-9f60-2a9d0b08d3af&pageNo=1&pageSize=10
```
...
```
POST  http://hd.huakunsoft.com.cn:13385/gim-boot/api/gim/tProjectinfo/fileMerge
```
